      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Link
              to="/contact"
              className="px-3 py-1.5 rounded-sm bg-[#0a1929]/80 border-2 border-[#217ED9] hover:bg-[#0a1929] text-white text-xs font-semibold transition-all uppercase tracking-wide"
            >
              Contact Us
            </Link>
          </div>
          ...
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="mt-4 pt-4 border-t border-slate-800">
              <Link
                to="/contact"
                onClick={() => setMobileMenuOpen(false)}
                className="block w-full text-center px-4 py-3 rounded-sm bg-[#0a1929]/80 border-2 border-[#217ED9] hover:bg-[#0a1929] text-white font-semibold mb-2 uppercase transition-all"
              >
                Contact Us
              </Link>
            </div>
